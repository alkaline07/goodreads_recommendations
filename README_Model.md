...
> **Note:** For general project information, team members, data sources, and basic setup instructions, please refer to [README.md](README.md).
...
For basic setup instructions (cloning repository, Python environment setup), please refer to [README.md](README.md).
...
> **Note:** For the complete folder structure, please refer to [README.md](README.md#folder-structure). The following section focuses on ML-specific modules.
...
> **Note:** For Data Analysis & Insights and Project Visuals, please refer to [README.md](README.md#data-analysis--insights).
